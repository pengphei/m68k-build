...
#define HAVE_anddi3 (!TARGET_COLDFIRE)
...
#define HAVE_iordi3 (!TARGET_COLDFIRE)
...
#define HAVE_xordi3 (!TARGET_COLDFIRE)
...
#define HAVE_clzsi2 (ISA_HAS_FF1)
#define HAVE_one_cmpldi2 (!TARGET_COLDFIRE)
