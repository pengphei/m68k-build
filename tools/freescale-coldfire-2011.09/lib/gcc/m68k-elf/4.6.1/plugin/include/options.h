...
enum opt_code
{
  ...
  OPT_mbitfield = 974,                       /* -mbitfield */
  OPT_mc68000 = 975,                         /* -mc68000 */
  OPT_mc68020 = 976,                         /* -mc68020 */
  OPT_mcfv4e = 977,                          /* -mcfv4e */
  OPT_mcpu32 = 978,                          /* -mcpu32 */
  OPT_mcpu_ = 979,                           /* -mcpu= */
  OPT_mdiv = 980,                            /* -mdiv */
  OPT_mfidoa = 981,                          /* -mfidoa */
  OPT_mhard_float = 982,                     /* -mhard-float */
  OPT_mid_shared_library = 983,              /* -mid-shared-library */
  OPT_mnobitfield = 984,                     /* -mnobitfield */
  OPT_mnortd = 985,                          /* -mnortd */
  OPT_mnoshort = 986,                        /* -mnoshort */
  OPT_mpcrel = 987,                          /* -mpcrel */
  OPT_mrtd = 988,                            /* -mrtd */
  OPT_msep_data = 989,                       /* -msep-data */
  OPT_mshared_library_id_ = 990,             /* -mshared-library-id= */
  OPT_mshort = 991,                          /* -mshort */
  OPT_msoft_float = 992,                     /* -msoft-float */
